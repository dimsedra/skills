...
Generate standalone, interactive, monochromatic HTML reports with integrated dark/light theme switching, high-contrast Mermaid diagrams, color-coded diff blocks, and terminal execution containers.
...
- **Visual Code Diffs & Logs**: Collapsible diff blocks and dedicated terminal evidence containers.
...
- `report.css`: Monochromatic responsive CSS design system.
- `REPORT-TEMPLATE.html`: Master HTML shell with theme toggle script and Mermaid initializer.
- `COMPONENTS.md`: Catalog of ready-to-use HTML component snippets (metric bars, diffs, terminal blocks, callouts).
